...
const DocumentUpload = () => {
  ...
  return (
    ...
    <div className="w-full justify-center flex flex-col gap-10 items-center relative">
      ...
      >
        <p className="bg-white rounded-lg py-2 px-4 cursor-pointer">Level 1</p>
        <p className="bg-white rounded-lg py-2 px-4 cursor-pointer">Level 2</p>
        <p className="bg-white rounded-lg py-2 px-4 cursor-pointer">Level 3</p>
        <p className="bg-white rounded-lg py-2 px-4 cursor-pointer">Level 4</p>
      </div>
      <div
      ...
      <Image src={"/dash.svg"} alt="dash" height={100} width={100} className="w-4/5 absolute bottom-0 right-0 w-[20rem]"/>
      </>
  );
};
